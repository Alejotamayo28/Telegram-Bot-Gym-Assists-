export const MAIN_MENU_MESSAGE = `👋 *¡Hola! Bienvenido al menú de usuario!*🎉
...
export const MAIN_MENU_FUNCTIONS_MESSAGE = `🔄 _Sigue explorando y utilizando las demás funciones de nuestro asistente virtual._ \n`
