...
exports.DELETE_WORKOUT = exports.UPDATE_WORKOUT = exports.GET_SINGLE_WORKOUT = exports.GET_WORKOUT_DATA = exports.INSERT_WORKOUT_QUERY = void 0;
exports.INSERT_WORKOUT_QUERY = `
INSERT INTO workout (id, day, name, series, reps, kg) VALUES ($1, $2, $3, $4, $5, $6)`;
exports.GET_WORKOUT_DATA = `
SELECT * FROM workout WHERE id = $1 AND day = $2`;
exports.GET_SINGLE_WORKOUT = `
