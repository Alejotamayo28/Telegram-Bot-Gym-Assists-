...
const insertClientData = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    let client;
    try {
...
const insertWorkout = ({ body, params }, res) => __awaiter(void 0, void 0, void 0, function* () {
    let client;
    try {
        const { id } = params;
        client = yield database_1.pool.connect();
...
const clientData = ({ params }, res) => __awaiter(void 0, void 0, void 0, function* () {
    let client;
    try {
        const { id } = params;
        client = yield database_1.pool.connect();
...
const clientDataUpdate = ({ params, body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    let client;
    try {
        const { id } = params;
        client = yield database_1.pool.connect();
